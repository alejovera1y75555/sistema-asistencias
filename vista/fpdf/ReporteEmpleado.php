...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(96, 10, utf8_decode("Ubicacion : " . $dato_info->ubicacion), 0, 0, '', 0);
      $this->Ln(5);
      ...
      $this->Cell(130);  // mover a la derecha
      $this->SetFont('Arial', 'B', 10);
      $this->Cell(85, 10, utf8_decode("RUT : " . $dato_info->rut), 0, 0, '', 0);
      $this->Ln(10);
...
$consulta_reporte_empleado = $conexion->query(" select empleado.nombre,empleado.apellido,empleado.cedula,cargo.nombre as 'nomCargo' from empleado inner join cargo ON cargo.id_cargo = empleado.cargo ");
...
while ($datos_reporte = $consulta_reporte_empleado->fetch_object()) {
   ...
   $pdf->Cell(62, 10, utf8_decode($datos_reporte->cedula), 1, 0, 'C', 0);
   $pdf->Cell(50, 10, utf8_decode($datos_reporte->nomCargo), 1, 1, 'C', 0);
}

$pdf->Output('Reporte Empleado.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)

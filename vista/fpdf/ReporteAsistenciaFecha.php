...
if (!empty($_GET["txtfechainicio"]) and !empty($_GET["txtfechafinal"]) and !empty($_GET["txtempleado"])) {
   ...
   class PDF extends FPDF
   {
      ...
      function Header()
      {
         ...
         $this->Cell(100, 10, utf8_decode("REPORTE DE ASISTENCIAS DETALLADO"), 0, 1, 'C', 0);
         $this->Ln(7);
...
if ($empleado == "todos") {
   ...
   $pdf->Output('ReportesAsistencias.pdf', 'I'); //nombreDescarga, Visor(I->visualizar - D->descargar)
}
